...
*这是Delphi Clipper库的翻译，使用的命名样式保留了Delphi的风格。
*                                                                              *
*******************************************************************************/
...
namespace ClipperLib
{
  ...
  using cInt = Int32;
    ...
    public class PolyNode
    {
        ...
        public void AddPath(IntPoint point)
        {
            this.m_polygon.Add(point);
        }
        ...
        /// <summary>
        /// 父母，表示父多边形，当一个多边形在另一个多边形内时，表示外边的多边形。
        /// </summary>
    ...
    internal struct Int128
    {
        ...
        /// <summary>
        /// 每次我们要乘以long数时构造两个新的Int128对象都是很慢的。 
        /// 因此，尽管调用Int128Mul方法看起来并不干净，但是代码的运行速度比我们使用*运算符的速度要快得多。
        /// </summary>
    ...
    /// 到目前为止，用于多边形填充的最广泛使用的缠绕规则是EvenOdd和NonZero
    /// （GDI，GDI +，XLib，OpenGL，开罗，AGG，Quartz，SVG，Gr32）。
    /// 其他规则包括正，负和ABS_GTR_EQ_TWO（仅在OpenGL中）
    ...
    /// <summary>
    /// 结束类型{封闭多边形，封闭线，开放对接，开放正方形，开放圆形}；
    /// </summary>
    ...
    /// <summary>
    /// 在裁剪解决方案中包含一个路径。 
    /// 当AEL中的边缘是裁剪解决方案的一部分时，它们将携带指向OutRec的指针。
    /// </summary>
    ...
    public class Clipper : ClipperBase
    {
      ...
      //------------------------------------------------------------------------------
        ...
        /// <summary>
        /// 清洁多边形，距离=以单位/像素为单位的接近度，低于该距离将去除顶点。
        /// 默认值〜= sqrt（2），因此，当相邻的顶点或半相邻的顶点的x和y坐标都在1个单位内时，第二个顶点将被去除。
        /// </summary>
    ...
    public class ClipperOffset
    {
        ...
        //------------------------------------------------------------------------------
        /// <summary>
        /// 修正方向。如果具有最低顶点的封闭路径的方向错误，则所有封闭路径的修正方向...
        /// </summary>
